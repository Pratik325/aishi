...
<div class="container register">
                <div class="row">
                    <div class="col-md-3 register-left">
                        ...
                        <h3>Welcome</h3>
                        <p>You are 30 seconds away to insert a student</p>
                    </div>
                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input name="erpid" type="text" class="form-control" placeholder=" ERP ID*" value="" required/>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="phone" class="form-control" placeholder="Phone number *" value="" />
                                        </div>
